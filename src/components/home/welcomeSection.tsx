...
const Welcome = () => {
  return (
    <div className="welcome-container">
        <img className="welcome-img" src={bukitimg} alt="hotel image" />
        <div className="welcome-text">
          <h1 className="header1">Moi!</h1>
          <h6 className="header1">TERVETULOA!</h6>
          <div>
          <p className="text1">
          ...
          <Button style={{ marginTop: 30}} variant="success">TIETOA MEISTÄ</Button>
          </div>
        </div>
    </div>
  )
